...
export class AddProductPhotoFields1750000000009 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "products" ADD COLUMN "image_path" VARCHAR(255)`);
    await queryRunner.query(`ALTER TABLE "products" ADD COLUMN "image_name" VARCHAR(255)`);
  }
